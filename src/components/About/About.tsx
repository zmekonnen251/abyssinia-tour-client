			...
			<div className='row'>
				<div className='col-1-of-2'>
					...
					<p className='paragraph'>
						...
						quam perferendis ipsam aperiam, placeat nulla fugiat, repellat
						distinctio fugit adipisci similique architecto facilis minima,
						eligendi asperiores qui. Earum, ratione!
					</p>
